...
//        [self.layer setCornerRadius:10];
        ...
        self.layer.frame = CGRectMake(0, 0, kScreenSize.width, kScreenSize.height);
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake((APPDELEGATE.window.frame.size.width - Size.width*0.125)/2, (APPDELEGATE.window.frame.size.height - Size.width*0.125)/2, Size.width*0.125, Size.width*0.125)];
