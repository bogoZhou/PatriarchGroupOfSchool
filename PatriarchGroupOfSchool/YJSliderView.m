...
- (void)bindStyleButton:(UIButton *)btn redNum:(NSInteger)redNum status:(BOOL)isSelected {
    ...
    [self.titleButton setTitleColor:isSelected ?  self.themeColor ? self.themeColor : kGreenColor : [kBlackColor colorWithAlphaComponent:0.7] forState:UIControlStateNormal];
...
- (void)setUpButtons {
    ...
    for (NSInteger index = 0; index < [self.delegate numberOfItemsInYJSliderView:self]; index ++) {
        ...
        [btn setTitleColor: self.themeColor ? self.themeColor : kGreenColor forState:UIControlStateNormal];
...
- (void)updateLabelInCellAtIndex:(CGFloat)index nextIndex:(CGFloat)nextIndex {
    ...
    [self changeButtonColor:nextBtn To:self.themeColor ? self.themeColor : kGreenColor WithScale:rate];
    [self changeButtonColor:currentBtn To:[kBlackColor colorWithAlphaComponent:0.7] WithScale:rate];
...
- (UIView *)sliderLine {
    if (_sliderLine == nil) {
        ...
        _sliderLine.backgroundColor = self.themeColor ? self.themeColor : kGreenColor;
